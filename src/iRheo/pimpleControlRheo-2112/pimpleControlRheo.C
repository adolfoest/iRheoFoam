...
namespace Foam
{
    defineTypeNameAndDebug(pimpleControlRheo, 0);
}
 
 
// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //
 
bool Foam::pimpleControlRheo::read()
{
...
bool Foam::pimpleControlRheo::criteriaSatisfied()
{
...
void Foam::pimpleControlRheo::setFirstIterFlag(const bool check, const bool force)
{
    DebugInfo
        << "corr:" << corr_
        << " corrPISO:" << corrPISO_
...
Foam::pimpleControlRheo::pimpleControlRheo
(
    fvMesh& mesh,
    const word& dictName,
    const bool verbose
...
bool Foam::pimpleControlRheo::loop()
{
    read();
