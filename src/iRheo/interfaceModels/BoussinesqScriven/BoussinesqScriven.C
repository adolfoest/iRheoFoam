...
{
    defineTypeNameAndDebug(BoussinesqScriven, 0);
...
Foam::interfaceModels::BoussinesqScriven::BoussinesqScriven
(
    const fvMesh& mesh,
    const word& dictName
)
...
Foam::interfaceModels::BoussinesqScriven::divTaus
(
    areaVectorField& Us
) const
{
...
Foam::interfaceModels::BoussinesqScriven::marangoni
(
...
Foam::tmp<Foam::areaVectorField>
Foam::interfaceModels::BoussinesqScriven::nTaut
(
    volVectorField& U,
    areaVectorField& Us
) const
...
Foam::scalarField
Foam::interfaceModels::BoussinesqScriven::snGradTau
(
...
Foam::interfaceModels::BoussinesqScriven::taus
(
    areaVectorField& Us
) const
{
...
Foam::tmp<Foam::areaTensorField>
Foam::interfaceModels::BoussinesqScriven::Ds
(
    areaVectorField& Us
) const
{
